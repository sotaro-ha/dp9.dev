...
function About() {
  return (
    <>
      ...
      <div className='mb-4'>
        <p className='mb-2'>このチュートリアルは、デザインサークルであるdesigning plus nine のサークル内勉強資料をweb上に公開したものです。</p>
        <p className='mb-2'>私たちは「design for everyone」をテーマに、デザインを通じたさまざまな活動を行っており、
